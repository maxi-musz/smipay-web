...
export function SmileyConversationModal({
  ...
  return (
    ...
    >
      <div
        className="flex max-h-[88vh] w-full max-w-lg flex-col overflow-hidden rounded-2xl bg-dashboard-surface shadow-xl"
      ...
      >
        ...
        <div className="border-t border-dashboard-border/60 px-4 py-3">
          {takenOver ? (
