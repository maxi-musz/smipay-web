...
import { Sparkles, RefreshCw, Settings, BarChart3, ScrollText, Lightbulb } from "lucide-react";
import { useAdminFirstTxReward } from "@/hooks/admin/useAdminFirstTxReward";
import { FirstTxRewardSkeleton } from "./_components/FirstTxRewardSkeleton";
import { FirstTxRewardSettings } from "./_components/FirstTxRewardSettings";
import { FirstTxRewardAnalytics } from "./_components/FirstTxRewardAnalytics";
import { FirstTxRewardHistory } from "./_components/FirstTxRewardHistory";
import { FirstTxRewardHowItWorksModal } from "./_components/FirstTxRewardHowItWorksModal";
...
export default function FirstTxRewardPage() {
  const {
    config,
    stats,
    configLoading,
  ...
  if (isInitialLoad) return <FirstTxRewardSkeleton />;
    ...
    <div className="min-h-screen bg-dashboard-bg">
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div>
              ...
              <p className="text-xs text-dashboard-muted">
                One-time bonus for users completing their first transaction
              </p>
            </div>
          </div>
      ...
      <div className="px-4 py-4 sm:px-6 sm:py-5 lg:px-8 space-y-4">
        ...
        {activeTab === "analytics" && (
          <>
            {analytics && config ? (
              <FirstTxRewardAnalytics analytics={analytics} config={config} />
            ) : analyticsLoading ? (
