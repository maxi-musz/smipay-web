...
interface PushBroadcastStatusBadgeProps {
  status: string;
}

export function PushBroadcastStatusBadge({ status }: PushBroadcastStatusBadgeProps) {
  const item = PUSH_BROADCAST_STATUSES.find((s) => s.value === status);
