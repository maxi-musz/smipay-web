...
export const metadata: Metadata = {
  ...
  description:
    "Smipay offers utilities payments, airtime and data, bill payments, transfers, and more. Experience seamless transactions with our user-friendly app designed for your convenience.",
  icons: {
    icon: [
