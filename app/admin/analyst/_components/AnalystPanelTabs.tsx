...
export type AnalystPanelId = "general";
...
interface AnalystPanelTabsProps {
  active: AnalystPanelId;
  onChange: (id: AnalystPanelId) => void;
}

export function AnalystPanelTabs({ active, onChange }: AnalystPanelTabsProps) {
  return (
